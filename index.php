      ...
      <div class="container-xxl py-5">
        <div class="container">
          <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
            ...
            <h1 class="mb-1">Most Popular Items</h1>
          </div>
                  ...
                  <div class="col-lg-6">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="w-100 d-flex flex-column text-start ps-4">
                        ...
                        >
                          <span>
                            <a href="home-res.php?menu=Tinutuan">Tinutuan</a>
                          </span>
                          <span class="text-primary">⭐</span>
                        </h5>
                        <small class="fst-italic"
                          >Tinutuan atau Bubur Manado adalah salah satu makanan khas Indonesia dari Manado, Sulawesi Utara</small
                        >
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="w-100 d-flex flex-column text-start ps-4">
                        ...
                        >
                          <span>
                            <a href="home-res.php?menu=Rahang+Tuna+Bakar">Rahang Tuna Bakar</a>
                          </span>
                          <span class="text-primary">⭐</span>
                        </h5>
                        <small class="fst-italic"
                          >Rahang tuna yang sudah dibersihkan, bisa dipotong maupun dibiarkan utuh, lalu dibakar hingga berwarna kehitaman atau matang.</small
                        >
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="w-100 d-flex flex-column text-start ps-4">
                        ...
                        >
                          <span>
                            <a href="home-res.php?menu=Rahang+Tuna">Rahang Tuna</a>
                          </span>
                          <span class="text-primary">⭐</span>
                        </h5>
                        <small class="fst-italic"
                          >Rahang tuna yang sudah dibersihkan, bisa dipotong maupun dibiarkan utuh, lalu dimasak, iyalah dimasak.</small
                        >
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="w-100 d-flex flex-column text-start ps-4">
                        ...
                        >
                          <span>
                            <a href="home-res.php?menu=Ayam+Woku">Ayam Woku</a>
                          </span>
                          <span class="text-primary">⭐</span>
                        </h5>
                        <small class="fst-italic"
                          > Ayam Woku merupakan olahan yang berasal dari bahan baku ayam yang dimasak dengan bumbu kuning pedas.</small
                        >
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="w-100 d-flex flex-column text-start ps-4">
                        ...
                        >
                          <span>
                            <a href="home-res.php?menu=Kepala+Babi+Goreng+Madu">Kepala Babi Goreng Madu</a>
                          </span>
                          <span class="text-primary">⭐</span>
                        </h5>
                        <small class="fst-italic"
                          >Kepala babi goreng madu sudah viral ke mana-mana sehingga ada yang beli dari luar kota Manado.</small
                        >
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="w-100 d-flex flex-column text-start ps-4">
                        ...
                        >
                          <span>
                            <a href="home-res.php?menu=Mie Ikan Cakalang">Mie Ikan Cakalang</a>
                          </span>
                          <span class="text-primary">⭐</span>
                        </h5>
                        <small class="fst-italic"
                          >Mie kuah cakalang tradisional dari Manado, yang dikenal kare aroma ikan cakalangnya.</small
                        >
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="w-100 d-flex flex-column text-start ps-4">
                        ...
                        >
                          <span>
                            <a href="home-res.php?menu=Klappertaart">Klappertaart</a>
                          </span>
                          <span class="text-primary">⭐</span>
                        </h5>
                        <small class="fst-italic"
                          >Klapertar dikenal sebagai kue khas Manado dengan bahan dasar kelapa, tepung terigu, susu, mentega dan telur.</small
                        >
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="w-100 d-flex flex-column text-start ps-4">
                        ...
                        >
                          <span>
                            <a href="home-res.php?menu=Halua Kenari">Halua Kenari</a>
                          </span>
                          <span class="text-primary">⭐</span>
                        </h5>
                        <small class="fst-italic"
                          >Halua kenari dibuat menggunakan bahan utama kacang kenari yang tumbuh subur di Sulawesi Utara.</small
                        >
                      </div>
                    </div>
                  </div>
