...
<div class="container-fluid h-100">
    ...
    <div class="isi">
        ...
        <br />
        <a href="#" class="btn btn-primary load-content" data-page="adminRestaurant.php">Restaurants List</a>
        <a href="#" class="btn btn-primary load-content" data-page="adminUsers.php">Users List</a>
    </div>
    <?php endif; ?>
